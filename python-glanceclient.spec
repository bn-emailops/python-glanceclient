%define name python-glanceclient
%define version 2012.2
%define unmangled_version 2012.2
%define unmangled_version 2012.2
%define release 1

Summary: Client library for OpenStack Image API
Name: %{name}
Version: %{version}
Release: %{release}
...
Prefix: %{_prefix}
BuildArch: noarch
Vendor: OpenStack Glance Contributors <glance@example.com>
